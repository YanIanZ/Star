...
class PlayerHeadAdapter21 implements PlayerHeadAdapter {
    ...
    PlayerHeadAdapter21() throws NoSuchMethodException, SecurityException, ClassNotFoundException, UnknownServerVersionException {
