 ...
 *
 */
public class StarLogger extends Logger {

    public StarLogger(@Nonnull Server server, @Nonnull String name) {
        super("star: " + name, null);

        setParent(server.getLogger());
        setLevel(Level.ALL);
    }

    public StarLogger(@Nonnull String name) {
